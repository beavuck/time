...
If you wish to report a security vulnerability but not in a public issue -- thank you! -- we ask that you follow the
following process.
...
Please send the above info, along with any other information you feel is pertinent to: beavuck.dev@gmail.com.

In addition, you may request that the project provide you a patched release in advance of the release announcement,
however, we can not guarantee that.

You will be emailed at the same time the public announcement is made.
